    ...
    <>
      ...
      >
        <div className={Classes.DIALOG_BODY}>
          <h2>What is Snippetly Studio?</h2>
          <p>
            <strong>Snippetly Studio</strong> - is a professional web application to create
            stunning graphical designs with AI-powered features. You can mix images, text, 
            illustrations and AI-generated content to make social media posts, presentations, 
            business cards, marketing materials and more.
          </p>
          <h2>Key Features</h2>
          <p>
            • AI-powered content summarization and generation<br/>
            • Professional design templates<br/>
            • Rich media library with icons, shapes, and images<br/>
            • QR code generation<br/>
            • Quote and typography tools<br/>
            • Cloud storage and collaboration<br/>
            • Export in multiple formats
          </p>
          <h2>Technology</h2>
          <p>
            <strong>Snippetly Studio</strong> is built on top of the powerful{' '}
            <a href="https://polotno.com/" target="_blank">
              Polotno SDK
            </a>
            {' '}with custom AI integrations and enhanced features for modern content creation.
          </p>
        </div>
